...
export default function Ask(props) {
  ...
  const handleNoClick = (event) => {
    ...
    if (noCount === 0) {
      ...
      setAskText("Yr teri last breath tak sath rahunga maan ja baby ")
      setEmojiAsk('😢')
    } else if (noCount === 1) {
      ...
      setAskText("Maan jaa meri jaan kitna bhao khayegi yr")
      setEmojiAsk('😭')
    }
    else {
  ...
  const handleYesClick = (event) => {
    ...
    setAskText("Yahhhh....I won you!!let's meet when I arrive ")
    setEmojiAsk('😍');
    setYesOrNow("Yes");
  }
